       ...
       <section
          ...
          >
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-bold teaxt-gray-800">
               Share board
              </h2>
              <CircleX
            ...
            <div  className="flex gap-3 justify-center ">
              <input
                ...
                />
                  ...
                  type="submit"
                  className="flex-1 py-5  px-4 rounded-lg bg-secondary text-white text-sm  font-medium hover:bg-secondary/80 transition-all duration-200 text-md  cursor-pointer "
                >
                Share
                </Button>
                </div>
