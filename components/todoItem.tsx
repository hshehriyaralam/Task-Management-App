  ...
  return (
    <section  className="group relative "  ref={setNodeRef} style={style} {...attributes} {...listeners} >
      ...
      >
        ...
        <div
          className={`flex items-center relative py-4  group-hover:py-0  gap-1 transition-all duration-200
         `}
        >
          <button
            onClick={() => handleEdit(todo)}
            className={` p-2   hidden group-hover:block   rounded-md bg-blue-100 transition-all duration-200  cursor-pointer  
          ...
          <button
            ...
            className="p-2  hidden group-hover:block rounded-md bg-red-100 transition-all duration-200 cursor-pointer"
            title="Delete task"
          >
